...
function init() {
    ...
    // Add event listener for split equally checkbox
...
function clearAllData() {
    if (!confirm('⚠️ Are you sure you want to clear ALL data? This will delete all members, expenses, and payments. This action cannot be undone!')) {
        return;
    }
